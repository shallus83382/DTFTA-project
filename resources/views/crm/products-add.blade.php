        ...
        <form method="POST" action="{{ route('crm.products.store') }}" enctype="multipart/form-data">
            ...
            <div class="filters-section">
                ...
                <div class="filter-group">
                    ...
                    <input id="title" name="title" type="text" class="filter-select" value="{{ old('title') }}"
                        required>
                </div>
                <div class="filter-group">
                ...
                <div class="filter-group">
                    ...
                    <input id="category" name="category" type="text" class="filter-select"
                        value="{{ old('category') }}">
                </div>
                <div class="filter-group">
                    <label for="sub_category">Sub-Category</label>
                    <input id="sub_category" name="sub_category" type="text" class="filter-select"
                ...
                <div class="filter-group">
                    ...
                    <input id="product_type" name="product_type" type="text" class="filter-select"
                        value="{{ old('product_type') }}">
                </div>
                <div class="filter-group">
                    <label for="tags">Tags / Keywords</label>
                    <input id="tags" name="tags" type="text" class="filter-select" value="{{ old('tags') }}"
                ...
                <div class="filter-group">
                    ...
                    <input id="shopify_product_id" name="shopify_product_id" type="text" class="filter-select"
                        value="{{ old('shopify_product_id') }}">
                </div>
                <div class="filter-group">
                    <label for="regular_price">Regular Price</label>
                    <input id="regular_price" name="regular_price" type="number" min="0" step="0.01"
                        class="filter-select" value="{{ old('regular_price') }}">
                </div>
                <div class="filter-group">
                    <label for="sale_price">Sale / Discount Price</label>
                    <input id="sale_price" name="sale_price" type="number" min="0" step="0.01"
                        class="filter-select" value="{{ old('sale_price') }}">
                </div>
                <div class="filter-group">
                    <label for="currency">Currency</label>
                    <input id="currency" name="currency" type="text" class="filter-select"
                        value="{{ old('currency', 'USD') }}">
                </div>
                <div class="filter-group">
                    <label for="tax_class">Tax Class</label>
                    <input id="tax_class" name="tax_class" type="text" class="filter-select"
                        value="{{ old('tax_class') }}">
                </div>
                <div class="filter-group">
                    <label for="stock_quantity">Stock Qty</label>
                    <input id="stock_quantity" name="stock_quantity" type="number" min="0"
                        class="filter-select" value="{{ old('stock_quantity', 0) }}">
                </div>
                <div class="filter-group">
                    ...
                    <select id="stock_status" name="stock_status" class="filter-select" required>
                        @foreach ($stockStatusOptions as $stockStatusOption)
                            <option value="{{ $stockStatusOption }}"
                                {{ old('stock_status', 'in_stock') === $stockStatusOption ? 'selected' : '' }}>
                ...
                <div class="filter-group">
                    ...
                    <input id="weight" name="weight" type="number" min="0" step="0.001"
                        class="filter-select" value="{{ old('weight') }}">
                </div>
                <div class="filter-group">
                    <label for="length">Length</label>
                    <input id="length" name="length" type="number" min="0" step="0.01"
                        class="filter-select" value="{{ old('length') }}">
                </div>
                <div class="filter-group">
                    <label for="width">Width</label>
                    <input id="width" name="width" type="number" min="0" step="0.01"
                        class="filter-select" value="{{ old('width') }}">
                </div>
                <div class="filter-group">
                    <label for="height">Height</label>
                    <input id="height" name="height" type="number" min="0" step="0.01"
                        class="filter-select" value="{{ old('height') }}">
                </div>
                <div class="filter-group">
                    <label for="shipping_class">Shipping Class</label>
                    <input id="shipping_class" name="shipping_class" type="text" class="filter-select"
                        value="{{ old('shipping_class') }}">
                </div>
                <div class="filter-group">
                    <label for="featured_image">Featured Image</label>
                    <input id="featured_image" name="featured_image" type="file" class="filter-select"
                        accept="image/*">
                </div>
                <div class="filter-group">
                    <label for="gallery_images">Gallery Images</label>
                    <input id="gallery_images" name="gallery_images[]" type="file" class="filter-select"
                        accept="image/*" multiple>
                </div>
                <div class="filter-group" style="width: 100%;">
                    <label for="short_description">Short Description</label>
                    <input id="short_description" name="short_description" type="text" class="filter-select"
